define({
  api: [
                  ...
                  body: [
                      {
                          ...
                          field: "firstName",
                          description:
                              "<p>First name of the account creator.</p>"
                      },
                      {
                          group: "body",
                          type: "String",
                          ...
                          field: "lastName",
                          description:
                              "<p>Last name of the account creator.</p>"
                      },
                      {
                          group: "body",
                          type: "String",
                      ...
                      },
                      {
                          ...
                          description:
                              "<p>Any dietary restrictions for the user. 'None' if there are no restrictions</p>"
                      },
                      {
                          group: "body",
                          type: "String",
      ...
      },
      {
          ...
          version: "0.0.8",
          description:
              "<p>Get all of the invites that currently exist in the database.</p>",
          success: {
              examples: [
                  {
                      title: "Success-Response: ",
      ...
      },
      {
          ...
          version: "0.0.8",
          description:
              "<p>sends link with token to be used with the account/create route</p>",
          parameter: {
              fields: {
                  body: [
                      {
                          ...
                          field: "email",
                          description:
                              "<p>email of the account to be created and where to send the link</p>"
                      },
                      {
                          group: "body",
                          type: "String",
                          ...
                          field: "accountType",
                          description:
                              "<p>the type of the account which the user can create, for sponsor this should specify tier as well</p>"
                      }
                  ]
              }
          },
                  ...
                  Header: [
                      {
                          ...
                          description:
                              "<p>the token that was provided in the reset password email</p>"
                      }
                  ]
              },
              examples: [
                  ...
                  body: [
                      {
                          ...
                          field: "accountId",
                          description:
                              "<p>ObjectID of the respective account</p>"
                      },
                      {
                          group: "body",
                          type: "String",
                          ...
                          field: "school",
                          description:
                              "<p>Name of the school the hacker goes to</p>"
                      },
                      {
                          group: "body",
                          type: "String",
                      ...
                      },
                      {
                          ...
                          description:
                              "<p>the graduation year of the hacker</p>"
                      },
                      {
                          group: "body",
                          type: "Boolean",
                          ...
                          field: "codeOfConduct",
                          description:
                              "<p>acceptance of the code of conduct</p>"
                      },
                      {
                          group: "body",
                          type: "Json",
                          ...
                          field: "application",
                          description:
                              "<p>The hacker's application. Resume and jobInterest fields are required.</p>"
                      }
                  ]
              },
              examples: [
                  ...
                  query: [
                      {
                          ...
                          field: "model",
                          description:
                              "<p>the model to be searched (Only hacker supported)</p>"
                      },
                      {
                          group: "query",
                          type: "Array",
                          ...
                          field: "q",
                          description:
                              "<p>the query to be executed. For more information on how to format this, please see https://docs.mchacks.ca/architecture/</p>"
                      }
                  ]
              }
          },
      ...
      },
      {
          ...
          description:
              "<p>This route only contains the ability to update a subset of a hacker's information. If you want to update a status, you must have Admin priviledges and use PATCH /hacker/status/:id.</p>",
          name: "patchHacker",
          group: "Hacker",
          version: "0.0.8",
          parameter: {
      ...
      },
      {
          ...
          version: "0.0.8",
          description:
              "<p><b>NOTE: This must be sent via multipart/form-data POST request</b></p>",
          parameter: {
              fields: {
                  param: [
                      {
              ...
              fields: {
                  "Success 200": [
                      ...
                      },
                      {
                          ...
                          field: "data",
                          description:
                              "<p>Location in the bucket that the file was stored.</p>"
                      }
                  ]
              },
              examples: [
              ...
              fields: {
                  body: [
                      ...
                      },
                      {
                          ...
                          field: "routes",
                          description:
                              "<p>The routes that this role gives access to</p>"
                      }
                  ]
              },
              examples: [
              ...
              fields: {
                  query: [
                      ...
                      },
                      {
                          ...
                          field: "page",
                          description:
                              "<p>the page number that you would like</p>"
                      },
                      {
                          group: "query",
                          type: "number",
                          ...
                          field: "limit",
                          description:
                              "<p>the maximum number of results that you would like returned</p>"
                      },
                      {
                          group: "query",
                          type: "any",
                          ...
                          field: "sort_by",
                          description:
                              "<p>any parameter you want to sort the results by</p>"
                      },
                      {
                          group: "query",
                          type: "boolean",
                          ...
                          field: "expand",
                          description:
                              "<p>whether you want to expand sub documents within the results</p>"
                      }
                  ]
              }
          },
                  ...
                  body: [
                      {
                          ...
                          field: "openTime",
                          description:
                              "<p>The opening time for the hackathon.</p>"
                      },
                      {
                          group: "body",
                          type: "Date",
                          ...
                          field: "closeTime",
                          description:
                              "<p>The closing time for the hackathon.</p>"
                      },
                      {
                          group: "body",
                          type: "Date",
                          ...
                          field: "confirmTime",
                          description:
                              "<p>The deadline for confirmation for the hackathon.</p>"
                      }
                  ]
              }
          },
              ...
              fields: {
                  body: [
                      ...
                      },
                      {
                          ...
                          field: "tier",
                          description:
                              "<p>Tier of the sponsor, from 0 to 5. 0 is lowest tier, and 5 is the custom tier.</p>"
                      },
                      {
                          group: "body",
                          type: "String",
                      ...
                      },
                      {
                          ...
                          field: "contractURL",
                          description:
                              "<p>URL link to the contract with the company.</p>"
                      },
                      {
                          group: "body",
                          type: "MongoID[]",
                          ...
                          field: "nominees",
                          description:
                              "<p>Array of accounts that the company wish to nominate as hackers.</p>"
                      }
                  ]
              }
          },
              ...
              fields: {
                  body: [
                      ...
                      },
                      {
                          ...
                          field: "devpostURL",
                          description:
                              "<p>Devpost link to hack. Once the link is sent, the hack will be considered to be submitted.</p>"
                      },
                      {
                          group: "body",
                          type: "String",
      ...
      },
      {
          ...
          version: "0.0.8",
          description:
              "<p>We use hackerId instead of teamId because authorization requires a one-to-one mapping from param id to accountId, but we are not able to have that from teamId to accountId due to multiple members in a team. Instead, we use hackerId, as there is a 1 to 1 link between hackerId to teamId, and a 1 to 1 link between hackerId and accountId</p>",
          parameter: {
              fields: {
                  param: [
                      {
              ...
              fields: {
                  "Error 4xx": [
                      ...
                      },
                      {
                          ...
                          field: "data",
                          description:
                              "<p>Query input that caused the error.</p>"
                      }
                  ]
              },
              examples: [
                  ...
                  body: [
                      {
                          ...
                          field: "accountId",
                          description:
                              "<p>MongoID of the account of the volunteer</p>"
                      }
                  ]
              }
          },
