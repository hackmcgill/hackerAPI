        ...
        util.auth.login(agent, util.account.waitlistedHacker0, (error) => {
            ...
            return agent
                ...
                .end(function (err, res) {
                    ...
                    res.body.data.team.members[0].should.equal(util.hacker.TeamHacker1);
                    res.body.data.team.members[1].should.equal(util.hacker.TeamHacker2);
                    res.body.data.team.members[2].should.equal(util.hacker.TeamHacker3);
                    res.body.data.team.members[3].should.equal(util.hacker.TeamHacker4);
