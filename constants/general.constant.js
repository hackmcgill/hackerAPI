...
const HACKER_REVIEWER_STATUS_YES = "Yes";
const HACKER_REVIEWER_STATUS_NO = "No";
const HACKER_REVIEWER_STATUS_MAYBE = "Maybe";
const HACKER_REVIEWER_STATUSES = [
    HACKER_REVIEWER_STATUS_NONE,
    HACKER_REVIEWER_STATUS_YES,
    HACKER_REVIEWER_STATUS_NO,
    HACKER_REVIEWER_STATUS_MAYBE,
];
...
module.exports = {
    ...
    HACKER_REVIEWER_STATUS_YES: HACKER_REVIEWER_STATUS_YES,
    HACKER_REVIWER_STATUS_NO: HACKER_REVIEWER_STATUS_NO,
    HACKER_REVIWER_STATUS_MAYBE: HACKER_REVIEWER_STATUS_MAYBE,
