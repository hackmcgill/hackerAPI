...
const DEVPOST_REGEX =
  /^(http(s)?:(\/\/)?)?(www\.)?(([-a-zA-Z0-9@:%._\+~#=]{2,256}\.)?devpost\.com)\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)$/;
...
const POST_ROLES = {
  Hacker: "postHacker",
  SponsorT1: "postSponsor",
  SponsorT2: "postSponsor",
  SponsorT3: "postSponsor",
  SponsorT4: "postSponsor",
  SponsorT5: "postSponsor",
  Volunteer: "postSponsor",
  Staff: "postSponsor",
};
